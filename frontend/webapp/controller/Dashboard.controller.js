sap.ui.define([
    ...
    var DashboardController = BaseController.extend("helphub.controller.Dashboard", {
         ...
         */
        // _openLegalPage lives in BaseController: Login (no session yet) needs it
        // for the Impressum link as well as this controller.
        ...
        _navigateToResults: function(oService) {
            ...
            // Heading uses the localised tile label, not the backend key ("Transport").
            var oBundle = this.getOwnerComponent().getModel("i18n").getResourceBundle();
            oModel.setProperty("/helpersNearbyHeading",
                oBundle.getText("helpersNearbyHeading", [oService.label || oService.name]));
